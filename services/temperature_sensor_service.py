...
class TemperatureSensorService:
    ...
    def get_temperature_sensor(self) -> TemperatureSensor:
        return temperature_sensor_dao.get()
    
    def update_temperature_sensor(self, temperature_sensor_update: TemperatureSensor) -> TemperatureSensor:
        return temperature_sensor_dao.update(temperature_sensor_update)